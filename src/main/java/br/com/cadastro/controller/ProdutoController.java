...
public class ProdutoController {
	...
	public ResponseEntity<Produto> inclusao(@RequestBody ProdutoRequest depositoRequest) {
	...
	public ResponseEntity<List<Produto>> consultaOrdens() {
	...
	public ResponseEntity<Produto> atualizar(@RequestBody ProdutoRequest depositoRequest) {
		logger.info("Iniciando a Inclusao do produtoService");
	...
	public ResponseEntity<List<Produto>> consultaByCodigoProduto(@RequestParam("codigo") String codigo) {
		logger.info("Iniciando a consulta do produtoService");
